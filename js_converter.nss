...
void JewelerConverter(object oPC, object oBench, int nNode)
{
    ...
    switch(nNode)
    {
      ...
      case 52: sProduct = "epiccraftingtmp"; sIngredient1 = "glob_base_res"; sIngredient2 = "js_jew_ring"; sType = "elyon_loot_9"; sPlaceableName = "<c « >Ring of Fortification</c>"; sIngredient2Type = "platinum"; nCost = 10000; nRetainItem=1; break;
      case 53: sProduct = "epiccraftingtmp"; sIngredient1 = "glob_base_res"; sIngredient2 = "js_jew_amul"; sType = "elyon_loot_6"; sPlaceableName = "<c « >Amulet of Spell Protection</c>"; sIngredient2Type = "platinum"; nCost = 10000; nRetainItem=1; break;
    }
