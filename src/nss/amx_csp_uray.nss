...
against the target for each ray fired. Each ray deals 4d6 Negative Energy damage.
The caster fires one ray at caster level 3, increasing to two at level 7 and
three at 11. The Dragon Disciple's caster level counts as their dragon disciple
level plus their bard and sorcerer levels for this spell.
If used on an undead, it will heal them instead of harming them.
*/
