...
void main()
{
    ...
    // Black Guard NE Aura
    effect eNEAura = EffectAreaOfEffect(AOE_MOB_DRAGON_FEAR, "****", "bg_ne_aura_rnd", "****");
    eNEAura = SupernaturalEffect(eNEAura);
    DelayCommand(0.5, ApplyEffectToObject(DURATION_TYPE_PERMANENT, eNEAura, OBJECT_SELF));
}
