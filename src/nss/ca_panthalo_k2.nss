/*  Merchant :: Panthalo :: Issue Kit :: Hin Fist

    --------
    Verbatim
    --------
    Panthalo will issue the player Hin Fist's kit.
...
const string KIT_REF_0  = "robesofthehinfis";
const string KIT_REF_1  = "bootsofthehinfis";
const string KIT_REF_2  = "mastergloveshf";
