/*  Merchant :: Panthalo :: Issue Kit :: Old Order

    --------
    Verbatim
    --------
    Panthalo will issue the player Old Order's kit.
...
const string KIT_REF_0  = "truerobesoftheol";
const string KIT_REF_1  = "bootsoftheoldord";
const string KIT_REF_2  = "masterglovesoo";
