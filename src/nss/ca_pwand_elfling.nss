...
void main( ){
    ...
    // Notify
    SendMessageToPC( oDM, "- You've made " + szPC_CharName + " an Elfling!" );
    SendMessageToPC( oPC, "- Well-done! You've been authorized by DM " + szDM_GameSpy + " to be an Elfling!" );
    ...
    DelayCommand( 3.0, AddElflingAbilitiesToBicFile( oPC ) );
