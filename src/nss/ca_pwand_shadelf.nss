/*  Amia :: DM Item :: Platinum Wand :: Give : Exotic Subrace: Shadow Elf

    --------
    Verbatim
    --------
    This script makes the targeted player a Shadow Elf.
...
void main( ){
    ...
    // Notify
    SendMessageToPC( oDM, "- You've made " + szPC_CharName + " an Shadow Elf!" );
    SendMessageToPC( oPC, "- Stay put, you will be transformed into an Shadow Elf!" );
    ...
    DelayCommand( 3.0, AddShadowElfAbilitiesToBicFile( oPC ) );
    return;
