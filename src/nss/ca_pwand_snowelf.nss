/*  Amia :: DM Item :: Platinum Wand :: Give : Exotic Subrace: Snow Elf

    --------
    Verbatim
    --------
    This script makes the targeted player a Snow Elf.
...
void main( ){
    ...
    // Notify
    SendMessageToPC( oDM, "- You've made " + szPC_CharName + " an Snow Elf!" );
    SendMessageToPC( oPC, "- Stay put, you will be transformed into an Snow Elf!" );
    ...
    DelayCommand( 3.0, AddSnowElfAbilitiesToBicFile( oPC ) );
