/*  Amia :: DM Item :: Platinum Wand :: Give : Bat Wings.

    --------
    Verbatim
    --------
    This script gives Bat Wings to a player.
...
void main( ){
    ...
    // Notify the DM.
    SendMessageToPC( oDM, "- You gave " + szPC_CharName + " some Bat Wings!" );
    // Notify the player.
    SendMessageToPC( oPC, "- Well-done! You've been given some Bat Wings by DM " + szDM_GameSpy + "!" );
