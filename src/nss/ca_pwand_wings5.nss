/*  Amia :: DM Item :: Platinum Wand :: Give : Butterfly Wings.

    --------
    Verbatim
    --------
    This script gives Butterfly Wings to a player.
...
void main( ){
    ...
    // Notify the DM.
    SendMessageToPC( oDM, "- You gave " + szPC_CharName + " some Butterfly Wings!" );
    // Notify the player.
    SendMessageToPC( oPC, "- Well-done! You've been given some Butterfly Wings by DM " + szDM_GameSpy + "!" );
