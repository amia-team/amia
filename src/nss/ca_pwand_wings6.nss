/*  Amia :: DM Item :: Platinum Wand :: Give : Demon Wings.

    --------
    Verbatim
    --------
    This script gives Demon Wings to a player.
...
void main( ){
    ...
    // Notify the DM.
    SendMessageToPC( oDM, "- You gave " + szPC_CharName + " some Demon Wings!" );
    // Notify the player.
    SendMessageToPC( oPC, "- Well-done! You've been given some Demon Wings by DM " + szDM_GameSpy + "!" );
