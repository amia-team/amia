// Conversation conditional to see if the PC can select Fiendish summons.
//
// Revision History
...
int StartingConditional()
{
    ...
    else if( GetAlignmentGoodEvil( oPC ) == ALIGNMENT_EVIL ) return TRUE;
    else if( GetAlignmentGoodEvil( oPC ) == ALIGNMENT_NEUTRAL && nChosen == 4) return TRUE;
