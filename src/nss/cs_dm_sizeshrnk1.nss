...
//:://////////////////////////////////////////////
/*
// This is a conversation script is for decreasing a player's size by intervals of -1%.
...
void main() {
    ...
    // Set target scaling to 0.01 (1%) larger than the current.
    float fTargetScaling = fCurrentScaling - 0.01;
