//::///////////////////////////////////////////////
//:: [DM Tools] Decrease Player Size [Amia]
//:://////////////////////////////////////////////
/*
// This is a conversation script is for decreasing a player's size by intervals of -5%.
...
void main() {
    ...
    // Set target scaling to 0.05 (5%) larger than the current.
    float fTargetScaling = fCurrentScaling - 0.05;
