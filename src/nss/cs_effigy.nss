...
//:: Updated By: Brett Billington, 2006-08-06: Added in visuals for a special summon.
...
void main()
{
    ...
    // Set the two visual effects.
    effect eInferno=ExtraordinaryEffect(EffectVisualEffect(VFX_DUR_INFERNO_CHEST));
    effect eRedGlow=ExtraordinaryEffect(EffectVisualEffect(VFX_DUR_GLOW_RED));


    // Place it onto the summon!
    DelayCommand(
        1.0,
        ApplyEffectToObject(
