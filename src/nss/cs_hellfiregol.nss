...
//:: Updated By: Kungfoowiz, 2005-09-24: Added function so summoned creature so they spawn in on fire.
...
void main()
{
    ...
    // set special vfx for the hellfire golem
    effect eHellfire=ExtraordinaryEffect(EffectVisualEffect(VFX_DUR_INFERNO_CHEST));

    // slap it onto the Hellfire golem to make it look the part
    DelayCommand(
        1.0,
        ApplyEffectToObject(
