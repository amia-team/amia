...
void main()
{
    ...
    effect eMist=ExtraordinaryEffect(EffectVisualEffect(VFX_DUR_GHOST_SMOKE));
    effect eGhost=ExtraordinaryEffect(EffectVisualEffect(VFX_DUR_GHOSTLY_VISAGE_NO_SOUND));
