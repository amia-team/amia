...
void main()
{
    ...
    effect eShadowskin=ExtraordinaryEffect(EffectVisualEffect(VFX_DUR_PROT_SHADOW_ARMOR));
    effect eRedeyes=ExtraordinaryEffect(EffectVisualEffect(VFX_EYES_RED_FLAME_HALFLING_FEMALE));
