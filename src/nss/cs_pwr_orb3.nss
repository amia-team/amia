/* Orb of Power: Lust
    ...
    4. PLC vfx
    5. Other gems status
    6. Unplot boss, remove gems, Candy
...
void main(){
    ...
    if( ( ( oBoss = GetNearestObjectByTag( sBabylonTag, oOrbOfPower, 1 ) ) != OBJECT_INVALID ) &&
        ...
        // Gem status
        if( ( oGem3 = GetItemPossessedBy( oOrbOfPower, "NW_IT_GEM006" ) ) != OBJECT_INVALID ){
            ...
            if( !GetLocalInt( oOrbOfPower, "spawned" ) ){
                ...
                object oOrb1 = GetNearestObjectByTag( "cs_pwr_orb1", oOrbOfPower, 1 );

                // Other gems status
                if( oOrb1 != OBJECT_INVALID )

                    if( ( oGem1 = GetItemPossessedBy( oOrb1, "NW_IT_GEM003" ) ) != OBJECT_INVALID ){
