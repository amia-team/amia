...
void main()
{
    ...
    int    nSpellDCBonus;
    int    nDamage;
    int    nSkillPenalty    = GetLocalInt( oTarget, "sandstorm_skill" );
    ...
    while(GetIsObjectValid(oTarget))
    {
        ...
        if( GetIsReactionTypeHostile( oTarget, oPC ) )
        {
            ...
            if( !nSkillPenalty )
            {
                SetLocalInt( oTarget, "sandstorm_skill", 6 );
            }
            else if( nSkillPenalty < 10 )
            {
                SetLocalInt( oTarget, "sandstorm_skill", nSkillPenalty++ );
            }

            nSkillPenalty = GetLocalInt( oTarget, "sandstorm_skill" );
            ...
            eSkill1 = EffectSkillDecrease( SKILL_CONCENTRATION, nSkillPenalty );
            eSkill2 = EffectSkillDecrease( SKILL_SPOT, nSkillPenalty );
            eSkill3 = EffectSkillDecrease( SKILL_DISCIPLINE, nSkillPenalty );
            eSkill4 = EffectSkillDecrease( SKILL_LISTEN, nSkillPenalty );
