...
//:: Updated By: Kungfoowiz, 2007-01-27: Added in eye candy for fire wight summon.
...
void main()
{
    ...
    // set special vfx for the winterwight
    effect eFireSkin = ExtraordinaryEffect( EffectVisualEffect( VFX_DUR_INFERNO_CHEST ) );

    // slap it onto the Fire wight to make it look the part
    DelayCommand(
        1.0,
        ApplyEffectToObject(
