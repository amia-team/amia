...
const int DMFI_LISTENING_GLOBAL = 0;
...
void dmwand_KickPC(object oTarget, object oUser)
{
   ...
   LogWarn ("dmfi_dmw_inc", GetName(oTarget) + " was booted from the game.  PC CD KEY: " + GetPCPublicCDKey(oTarget) + " PC IP ADDRESS: " + GetPCIPAddress(oTarget));
