/*
    Environmental Ability Damage Triggers
        OnHeartbeat application (or re-application) of Ability Decrease
*/
...
void main()
{
    int nDam = GetLocalInt( OBJECT_SELF, "abil_dam" );
    int nAbil = GetLocalInt( OBJECT_SELF, "ability" );
    ...
    while( GetIsObjectValid( oTarget ) )
    {
        ...
        if( nSave == 1 )
        {
            ...
            {
                //apply effect
                effect eSick = SupernaturalEffect( EffectAbilityDecrease( nAbil, nDam ) );
