// Item script to transform into a brass dragon.
//
// Revision History
...
// Changes appearance of PC between standard and brass dragon.
//
void ActivateItem( )
{
    ...
    if ( nAppearType == APPEARANCE_TYPE_DRAGON_BRASS ) {
        ...
        DelayCommand( 0.1, SetCreatureAppearanceType(oPC, APPEARANCE_TYPE_DRAGON_BRASS) );
    }
}
