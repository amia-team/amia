...
// Changes appearance of PC between standard and cragcat orm.
//
void ActivateItem( )
{
    ...
    if ( nAppearType == APPEARANCE_TYPE_CAT_CRAG_CAT ) {
        ...
        DelayCommand( 0.1, SetCreatureAppearanceType(oPC, APPEARANCE_TYPE_CAT_CRAG_CAT ) );
    }
}
