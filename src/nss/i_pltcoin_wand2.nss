// Platinum Coin Widget: Level Rebuild
...
void main(){
    ...
    if(GetIsDM(oDM)==FALSE){
        ...
        string szMessage=
            ...
            "|PC="                                                              +
            GetName(oPC)                                                        +
            "|Reason=Player has been awarded a Platinum Coin: Level Rebuild.|</c>";
    ...
    // notify the player that she has been awarded the Platinum Coin: Level Rebuild
    SendMessageToPC(
        oPC,
        "<cÌwþ>Well done, you've just been awarded a Platinum Coin: Level Rebuild!</c>");
