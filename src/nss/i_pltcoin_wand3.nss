...
void main(){
    ...
    if(GetIsDM(oDM)==FALSE){
        ...
        string szMessage=
            ...
            "|PC="                                                              +
            GetName(oPC)                                                        +
            "|Reason=Player has been awarded a Platinum Coin: Tail.|</c>";
    ...
    // notify the player that she has been awarded the Platinum Coin: Tail
    SendMessageToPC(
        oPC,
        "<cÌwþ>Well done, you've just been awarded a Platinum Coin: Tail!</c>");
