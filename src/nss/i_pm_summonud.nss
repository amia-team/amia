...
void LaunchConvo( object oPC){
    SetLocalString(oPC,"ds_action","i_pm_summonud");
    AssignCommand(oPC, ActionStartConversation(oPC, "c_pm_summonud", TRUE, FALSE));
}
...
void SetSummons( object oPC, int nNode)
{
      ...
      object oWidget = GetItemPossessedBy(oPC, "pm_summonud");
