...
int ResolveTransport( object oPC, object oArea ){
    ...
    if ( sLastSession != sSession && sTarget == "" && GetTag( oArea ) != "amia_entry" && GetPCKEYValue( oPC, "dead_in" ) != GetLocalInt( oModule, "Module" ) ) {
        ...
        if ( !GetIsDM( oPC ) ){
            ...
            FloatingTextStringOnCreature( "<c� �>Wait a moment, you'll be ported back to the Entry.</c>", oPC, FALSE );
        ...
        if ( GetIsObjectValid( oWP ) ){
            ...
            FloatingTextStringOnCreature( "<c� �>Wait a moment, you'll be ported to your destination.</c>", oPC, FALSE );
