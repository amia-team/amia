/*  Amia :: Monster :: OnSpawn

    --------
    Verbatim
    --------
    This script executes when a monster is spawned in Amia.
    ...
    ----------------------------------------------------------------------------
    ??????  JAI         Initial Release.
    031506  kfw         Customized OnDeath VFX.
    080806  kfw         Optimization and new despawner!
    033107  kfw         Decreased initial despawn to 1 minute, 45 seconds.
...
void main( ){
    ...
    int nVFX                = GetLocalInt( oMonster, "cs_vfx" );

    SetLocalString( oMonster, "ai", "j_ai" );
...
************************* [Combat - Dragons] **********************************/
    ...
    SetAIInteger(AI_DRAGON_FREQUENCY_OF_BUFFET, 7);
...
************************* [Other - Behaviour/Generic] *************************/
    ...
    SetSpawnInCondition(AI_FLAG_OTHER_NO_COMMONER_ALIGNMENT_CHANGE, AI_OTHER_MASTER);
        // This turns off the alignment adjustment if you kill a non-evil NPC
