/*
  Job System Item Refresh Script - Converts the resources into different material
...
void LaunchJobConverter(object oPC, object oBench, int nNode)
{
    ...
    else if(sJob == "Item_Refresh")
    {
      ItemRefreshConverter(oPC,oBench,nNode);
    }
...
void CraftProperties(object oPC, object oCraftedItem, string sType, string sMaterial, string sPlaceableName)
{
      ...
      else if(sMaterial == "plc")// For PLC items we set the resref on the PLC spawner and set the name from the variable in the switch statement
      {
