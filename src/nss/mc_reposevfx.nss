...
//:: Updated By: MoshingChris, 2014-01-31: Added vfx ghost concealment vfx for Death Domain Summons
...
void main()
{
    ...
    // set special vfx for the Death Domain Summons
    effect eEffect=ExtraordinaryEffect(EffectVisualEffect(VFX_DUR_GLOW_LIGHT_PURPLE));
