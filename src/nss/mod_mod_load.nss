...
void InitialiseColours(){
    ...
    SetCustomToken( 5116, "<c�� >" ); // orange
    SetCustomToken( 5117, "<c�e >" ); // dark orange
    SetCustomToken( 5118, "<cڥ#>" ); // brown
    SetCustomToken( 5119, "<c�q >" ); // dark brown
    SetCustomToken( 5120, "<c���>" ); // Epic Loot green
    SetCustomToken( 5121, "<c�i�>" ); // Dream Coin purple
    SetCustomToken( 5122, "<c~��>" ); // Job System blue
    SetCustomToken( 5123, "<c � >" ); // Quest System green
    SetCustomToken( 5124, "<c��#>" ); // Epic Crafting gold
    SetCustomToken( 5125, "<c���>" ); // Djinn blue
    SetCustomToken( 5126, "<c�z >" ); // Dungeon DTS orange
}
