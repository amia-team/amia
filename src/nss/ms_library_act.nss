...
//------------------------------------------------------------------------------
    ...
    string sShelfTag    = GetLocalString ( oPC, "ShelfTag" );
    object oBS          = GetObjectByTag( sShelfTag );
    int nBlockTime      = GetLocalInt( oBS, "BlockTime" );
    int nBooks          = GetLocalInt( oBS, "NumberOfBooks" );
    int nDC             = GetLocalInt( oBS, "DC" );
    object oPLC;
    string sTarget      = GetLocalString( oBS, "target" );
    string sSpawnpoint  = GetLocalString( oBS, "spawnpoint" );
    string sResref;

//------------------------------------------------------------------------------

    DeleteLocalString( oPC, "ShelfTag" );
