...
//------------------------------------------------------------------------------
        ...
        // Search successful
            ...
            SetLocalString( oPC, "ds_action", "ms_library_act" );
            SetLocalObject( oPC, "ds_target", OBJECT_SELF );
            SetLocalString( oPC, "ShelfTag", bksTag );

            int i = 1;

            int nIndex = GetLocalInt( OBJECT_SELF, "Book_" + IntToString( i ) );
            ...
            while ( nIndex ){
                ...
                nIndex = GetLocalInt( OBJECT_SELF, "Book_" + IntToString( i ) );
            }
