...
//:: Updated On: June, 12, 2006 (kfw) - Added Amia's Racial System refresher to RemoveAllEffects() function.
//:://////////////////////////////////////////////

// 2009/02/23 disco            Updated racial/class/area effects refresher


// @@@ Custom Amia Addition
...
// @@@ Custom Amia Change: Cap is now 20
    if ( nAdjust > 20 ) nAdjust = 20;
    if ( nAdjust < -20 ) nAdjust = -20;
...
// * removes all negative effects
// updated and cleaned by Disco, 2009-02-23
void RemoveEffects( object oDead ){
