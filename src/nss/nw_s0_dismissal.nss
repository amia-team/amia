...
//  7/15/2016   msheeler    removed free +6 to the spell save DC
...
// End of Spell Cast Hook
    ...
    while(GetIsObjectValid(oTarget))
    {
        ...
        if( GetHasSpellEffect( SPELL_TIME_STOP, oMaster ) ) {
            ApplyEffectToObject( DURATION_TYPE_INSTANT, EffectVisualEffect( VFX_IMP_GLOBE_USE ), oMaster );
            return;
        }
