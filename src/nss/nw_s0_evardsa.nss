    ...
    if ( nNumberTargets >= 0 ){
        ...
        if (spellsIsTarget( oTarget, SPELL_TARGET_STANDARDHOSTILE, GetAreaOfEffectCreator() ) ){
            ...
            if ( nNumberTargets < nMinimumTargets ){
               ...
               // If there is only one target in the area,
               // then only a portion of the tentacles should be able to reach them.
