...
//:://////////////////////////////////////////////
/*
    Modified 04/10/13 Glim - Changed to set bonus instead of per level bonus.
*/
...
// End of Spell Cast Hook
    ...
    int nBonus = 15;
    //Need to check for spell focus before setting eLore
    if (GetHasFeat (FEAT_SPELL_FOCUS_DIVINATION, OBJECT_SELF))
    {
       nBonus = 20;
    }
