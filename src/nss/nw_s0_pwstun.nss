...
// ---------- ---------------- ---------------------------------------------
// 02/10/2012 Mathias          Changed to add 15 hit points to the range of targets per divination focus feat.
//
...
// End of Spell Cast Hook
    ...
    else if (nHP >= ( 101 + nHPBonus ) && nHP <= ( 150 + nHPBonus ) )
    {
        nDuration = d4(1);
        nMeta = 4;
    }
    else if (nHP >= ( 51 + nHPBonus )  && nHP <= ( 100 + nHPBonus ) )
    {
        nDuration = d4(2);
        nMeta = 8;
    }
