/*  Spell :: Restoration
    ...
    Verbatim
    --------
    This spellscript removes ill effects according to the spell Restoration.
    ...
    while( GetIsEffectValid( eEffect ) ){
        ...
        switch( nEffectType ){
            ...
            case EFFECT_TYPE_NEGATIVELEVEL:{
                ...
                if ( GetName( GetEffectCreator( eEffect ) ) != "ds_norestore" && !GetEffectIsPolyEffect( eEffect, oPC ) && !WhiteListedSpells(GetEffectSpellId(eEffect))  && (GetEffectTag(eEffect) == "") ){
