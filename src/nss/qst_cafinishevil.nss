/*! \file qst_cafinishevil.nss
 * \brief Scripted quests evil finish.
 *
 * Conversation action to reward the PC for finishing a quest in an
 * evil fashion.
 * \verbatim
 * Revision History
...
void main( ){
    ...
    if ( sItemTag == "" ) {
        ...
        QST_FinishQuest( oPC, sQuestTag, QST_STATE_EVIL );
