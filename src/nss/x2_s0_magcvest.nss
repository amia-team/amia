...
// End of Spell Cast Hook
    ...
    object oMyArmor   =  GetTargetedOrEquippedArmorForSpell(SPELL_MAGIC_VESTMENT);
    ...
    if(GetIsObjectValid(oMyArmor) )
    {
        ...
        if (nDuration>0)
        {
            ...
            ApplyEffectToObject(DURATION_TYPE_TEMPORARY, eDur, GetItemPossessor(oMyArmor), NewHoursToSeconds(nDuration));
            AddACBonusToArmor(oMyArmor, NewHoursToSeconds(nDuration),nAmount);
    }
        return;
    }
        else
