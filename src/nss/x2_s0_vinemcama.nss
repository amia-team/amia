...
//:: 7/9/2016   msheeler    added move silently to skill bonus
...
void main()
{
    ...
    effect eSkill2 = EffectSkillIncrease (SKILL_MOVE_SILENTLY, 4);
    ...
    if(spellsIsTarget(oTarget, SPELL_TARGET_ALLALLIES, GetAreaOfEffectCreator()))
    {
        if(!GetHasSpellEffect(GetSpellId(), oTarget))
        {
            ...
            ApplyEffectToObject(DURATION_TYPE_PERMANENT, eSkill2, oTarget);
        }
    }
}
