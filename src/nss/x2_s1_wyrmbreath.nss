...
void main()
{
    ...
    switch (nType)
    {
        case 663: //white
            ...
            nDice       = GetNewCasterLevel( OBJECT_SELF, (GetLevelByClass(CLASS_TYPE_SHIFTER,OBJECT_SELF) /3)+1 );
            break;
        ...
        case 666: //green
            ...
            nDice        = GetNewCasterLevel( OBJECT_SELF, (GetLevelByClass(CLASS_TYPE_SHIFTER,OBJECT_SELF) /2)+1 );
            break;
    ...
    //--------------------------------------------------------------------------
    int  nDC  = GetShifterDC( OBJECT_SELF, ShifterGetSaveDC(OBJECT_SELF,SHIFTER_DC_NORMAL) );
    //Added cap (20d4) for all
    nDamageDie = 4;
    if( nDice > 20 )
        nDice = 20;
    //--------------------------------------------------------------------------
