...
void main()
{
    ...
    FloatingTextStringOnCreature("You have had 2 DCs removed.", player, FALSE);
    SendMessageToAllDMs(GetPCPlayerName(player) + " has had 2 DCs removed.");
    }
    else
    {
